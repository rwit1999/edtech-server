...
exports.deleteUser = exports.updateUserRole = exports.getAllUsers = exports.updateProfilePicture = exports.updatePassword = exports.updateUserInfo = exports.socialAuth = exports.getUserInfo = exports.updateAccessToken = exports.logoutUser = exports.loginUser = exports.activateUser = exports.createActivationToken = exports.addAdmin = exports.registerUser = void 0;
...
exports.registerUser = (0, catchAsyncError_1.CatchAsyncError)(async (req, res, next) => {
    try {
        ...
        const isEmailExists = await user_model_1.default.findOne({ email: email });
        if (isEmailExists) {
...
exports.addAdmin = (0, catchAsyncError_1.CatchAsyncError)(async (req, res, next) => {
    try {
        const { name, email, password } = req.body;
        const role = "admin";
...
const createActivationToken = (user) => {
    ...
    const token = jsonwebtoken_1.default.sign({ user, activationCode }, process.env.JWT_SECRET, { expiresIn: "5m" });
...
exports.loginUser = (0, catchAsyncError_1.CatchAsyncError)(async (req, res, next) => {
    try {
        ...
        if (!email || !password)
            return next(new ErrorHandler_1.default("Please enter both the fields", 400));
        const user = await user_model_1.default.findOne({ email }).select('+password');
        if (!user) {
            return next(new ErrorHandler_1.default("Please enter valid email or password", 400));
        }
